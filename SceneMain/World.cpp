...
void World::calculateLight(sf::Vector3i source, sf::Vector3i radius) {
    //BFS TO THE MAX
                ...
                if (!outOfBounds(x,y,z)){
                    ...
                    case 0: //air
                        if(x == source.x-radius.x || x == source.x+radius.x
                            ...
                            setCubeAbs(x,y,z,Cube(0,1));
                        break;
                    case 4: //lightblock
                        setCubeAbs(x,y,z,Cube(4,LIGHTMAX));
                        blocksToCheck.push(sf::Vector3i(x,y,z));
                        break;
                    default:
    ...
    while(!blocksToCheck.empty()) {
        ...
        if(getCubeAbs(source.x,source.y,source.z).light == 2) {
            blocksToCheck.pop();
        }
        else {
